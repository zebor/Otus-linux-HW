...
Скрипт [raid10.sh] (./HW02/raid10.sh) для автоматического создания RAID по большей части копирует предыдущие операции
...
Файл конфигурации [mdadm.conf] (./HW02/mdadm.conf)
Файл [Vagrantfile] (./HW02/Vagrantfile)
